...
> 🔴 **이 문서는 초기(2026-06~07-11) 논의 기록입니다. 대부분 이미 구현되었습니다.**
> 최신 상태는 **`HANDOVER-2026-07-28.md`**, 반드시 지켜야 할 운영 규칙은 **`CLAUDE.md` §2-A/§2-B/§2-C** 를 보세요.
> 아래 "애드센스 재승인 확인" 항목은 진행되어 **2026-07-28 재신청 완료 · 심사 대기** 상태입니다.
