    ...
    return (
      ...
      <div style={{ height: "100%", width: "100%", position: "relative" }}>
        <MapContainer
          ...
          // ─── 월드 랩(무한 가로 반복) 제거 ───
          // 세계지도 한 바퀴에 좌우 52도씩(=40×1.3) 여유를 준 범위로 이동 제한.
          // (정확히 -180~180 으로 막으면 minZoom 이 자동으로 과하게 제한되어 대륙 단위
          //  축소가 안 되므로, 여유를 넉넉히 둬서 모든 대륙 포커싱은 되고 무한반복만 막는다.)
          //  ※ 특정 대륙에서 여전히 잘리면 이 여유값(232)만 더 키우면 된다.
          //  타일 자체 반복 방지는 아래 TileLayer 의 noWrap 이 담당한다.
          maxBounds={[
            [-90, -232],
            [90, 232],
          ]}
